...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(this, "ca-app-pub-7479732637897937~8153297660");
        ...
        fabb1=(com.github.clans.fab.FloatingActionButton) findViewById(R.id.item1);
        fabb2=(com.github.clans.fab.FloatingActionButton) findViewById(R.id.item2);
        fabb3=(com.github.clans.fab.FloatingActionButton) findViewById(R.id.item3);
        ...
        fabb2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                text.putExtra("android.intent.extra.TEXT", " Hey guys I've using this NEWS blender app lately developed by hoogle , it helps me to stay updated in terms of NEWS around me and that too in real time. it including some of the latest features and user friendly layout for easy operation. It app is recommended to all by professionals . click on this to download hindi version ------> https://play.google.com/store/apps/details?id=com.hoogle.news  click on this link to download English version ---------->https://play.google.com/store/apps/details?id=com.hoogle.news2");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.hoogle.news")));
        }
        else if (id == R.id.da) {
